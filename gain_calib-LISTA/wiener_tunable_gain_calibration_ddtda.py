# -*- coding: utf-8 -*-
"""Wiener_tunable_gain_calibration_DDTDA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gooJmMvb3H7XKhP6quayM1sjEvWYFa0L
"""
...
def LISTA_train(X, Y, X_val, Y_val, numEpochs, numLayers, device, learning_rate, batch_size, A):
    ...
    for epoch in range(numEpochs):
        ...
        for iter, data in enumerate(dataLoader_train):
            ...
            # print(torch.norm(X_batch_hat[-1]))
...
X = datagenerator.generate_sparse_signal(numTrain) #genarting sparse common samples
...
net_mixed = LISTA_train(X_train_mixed, Y_train_mixed, X_val_mixed, Y_val_mixed, numEpochs, numLayers, device, learning_rate, batch_size, A = A)

print(f'time taken is {time.time() - start}')

# torch.save(net_mixed, "/content/drive/My Drive/Weiner/random_close_to_zero/DDTDA_epoch_100_lr_5e_5.pth")
