# -*- coding: utf-8 -*-
"""Wiener_normal_gain_calibration_JT.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1foty393gDd7TDjHO5jz90pO2GYgRGbdJ
"""
...
X = datagenerator.generate_sparse_signal(numTrain) #genearing sparse samples
...
# net_mixed = torch.load("/content/drive/My Drive/Weiner/random_close_to_zero/JT_epoch_150_lr_5e_5.pth", weights_only = False)
...
torch.save(net_mixed, "/content/drive/My Drive/Weiner/random_close_to_zero/JT_epoch_150_lr_5e_5.pth")
